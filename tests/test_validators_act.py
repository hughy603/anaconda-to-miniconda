"""Tests for the act validator module."""
...
from github_actions_validator.validators.act import (
    build_act_command,
    prepare_event_file,
...
class TestValidatorsAct:
    ...
    @patch("github_actions_validator.validators.act.prepare_event_file")
    ...
    @patch("subprocess.run")
    @patch("github_actions_validator.validators.act.build_act_command")
    ...
    @patch("github_actions_validator.validators.act.validate_execution")
