...
from typing import Literal, TypeAlias, TypeGuard, Never, assert_never
...
def is_conda_environment(path: PathLike) -> bool:
    ...
    return (conda_meta.exists() and 
            (python_exec.exists() or bin_dir.exists()))
...
def set_log_level(level: LogLevel) -> None:
    ...
    match level:
        ...
        case _:
            assert_never(level)  # Ensure exhaustive matching
