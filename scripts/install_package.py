...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="Install packages using UV instead of regular pip"
    )
    parser.add_argument(
        "packages", nargs="*", help="Package(s) to install"
    )
    parser.add_argument(
        "-e", "--editable", action="store_true", help="Install in editable mode"
    )
    parser.add_argument(
        "-r", "--requirement", help="Install from requirements file"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--docs", action="store_true", help="Install documentation dependencies"
    )
    parser.add_argument(
